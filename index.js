...
// 📌 1. أمر إرسال لوحة الراديو (مثل الصورة الأولى)
...
// 📌 2. معالجة الضغط على الزر وإدخال رقم الموجة (مثل الصورة الثانية والثالثة)
client.on('interactionCreate', async (interaction) => {
    ...
    if (interaction.isModalSubmit() && interaction.customId === 'radio_modal_submit') {
        ...
        try {
            ...
            // إرسال نفس الرسالة التأكيدية الخاصة بالضبط (الصورة الثالثة)
...
// ضع توكين البوت الجديد هنا
client.login('YOUR_NEW_BOT_TOKEN');
const { 
    Client, 
    GatewayIntentBits, 
    ActionRowBuilder, 
